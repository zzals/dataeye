...
<script type="text/javascript">
	...
	function goPage(div) {
		...
		if(div=="list") {
			...
			if(!cardLoad) {
				var param = {"_search":false,"nd":1566802058509,"rows":10,"page":1,"sidx":"","sord":"asc","queryId":"portal.report.reportList","searchKey":"_all","searchValue":"","cateIds":cateIds, "rGubun":""}
				$.ajax({ 
...
<section class="content-header">
	...
	<script src="<spring:url value="/app/portal/pages/report/reportList3.js"/>"></script>
</body>
</html>
