...
<script type="text/javascript">
	...
	function goPage(div) {
		...
		if(div=="list") {
			...
			if(!cardLoad) {
				var param = {"_search":false,"nd":1566802058509,"rows":10,"page":1,"sidx":"","sord":"asc","queryId":"portal.report.recentUsgReportList","searchKey":"_all","searchValue":"","cateIds":cateIds}
				$.ajax({ 
			...
			$.ajax({
				...
				success: function(result){
					...
					if(!$(object).hasClass('fa-star')){
						goLink('portal/report/bookmarkReportList');
					}else{
						gridLoad();
					}
				}
...
<section class="content-header">
	...
	<script src="<spring:url value="/app/portal/pages/report/recentUsgReportList.js"/>"></script>
</body>
</html>
