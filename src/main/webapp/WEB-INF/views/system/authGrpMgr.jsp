			...
			<div class="col-xs-12">
				<div class="box">
		            <div class="box-header">
		              <h3 class="box-title"><i class="fa fa-chevron-right" aria-hidden="true"></i>권한 그룹</h3>
		              <div class="navbar-form navbar-right">
						<button type="button" id="btnAuthGrpInsert" class="btn btn-default">등록</button>
						<button type="button" id="btnAuthGrpUpdate" class="btn btn-default">수정</button>
						<button type="button" id="btnAuthGrpRemove" class="btn btn-default">삭제</button>
					  </div>
		            </div>
		            <!-- /.box-header -->
			...
			<div class="col-xs-12">
				<div class="box">
		            <div class="box-header">
		              ...
		              <div class="navbar-form navbar-right">
						<button type="button" id="btnRoleGrpInsert" class="btn btn-default">추가</button>
						<button type="button" id="btnRoleGrpDelete" class="btn btn-default">삭제</button>
					  </div>
		            </div>
		            <!-- /.box-header -->
...
<!-- /.content -->
<script src="<spring:url value="/app/system/pages/authGrpMgr.js"/>"></script>
</body>
</html>