        ...
        <div class="modal-dialog" style="width: 920px;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="box box-info boxArea" style="padding: 0px;">
        ...
        if (APRV.fn.isempty(aprvInfo) || APRV.fn.isempty(aprvLineInfo)) {
            ...
            $('#jqGridAprv').jqGrid({
                ...
                colModel: [
                    ...
                    {name: 'USER_ID', index: 'USER_ID', label: 'USER_ID', hiden: true},
                    {name: 'APRV_INDEX', index: 'APRV_INDEX', label: 'APRV_INDEX', hiden: true},
                    {name: 'APRV_LINE_MNGR_ID', index: 'APRV_LINE_MNGR_ID', label: 'APRV_LINE_MNGR_ID', hiden: true},
            ...
            $('button[id^=btn]').on('click', function () {
                ...
                else if (this.id === 'btnAprvConfirm') {
                    AprvDialog.confirm('결재 요청하시겠습니까?', function (result) {
                        if (result === true) {
                            if (APRV.fn.byteCheck('#aprvDesc', 300)) {
