...
<body>
				...
				<div class="collapse navbar-collapse">
					<div class="navbar-form navbar-left">
						<div class="form-group">
							<input id="searchValue" class="form-control" placeholder="Search" de-search-key="UI_NM">
						</div>
				...
				<div class="col-xs-12">
					<div class="box">
			            <div class="box-header">
			              <h3 class="box-title"><i class="fa fa-chevron-right" aria-hidden="true"></i>UI 목록</h3>
			              <div class="navbar-form navbar-right">
							<button type="button" id="btnCopy" class="btn btn-default">복사하기</button>
	...
	<!-- /.content -->	
    <script src="<spring:url value="/app/admin/pages/objUI.js"/>"></script>
</body>
</html>