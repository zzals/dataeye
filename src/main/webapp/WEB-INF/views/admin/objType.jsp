...
<body>
				...
				<div class="collapse navbar-collapse">
					<div class="navbar-form navbar-left">
						<div class="form-group">
							<input id="searchValue" class="form-control" placeholder="Search" de-search-key="OBJ_TYPE_NM">
						</div>
				...
				<div class="col-xs-12">
					<div class="box">
			            <div class="box-header">
			              <h3 class="box-title"><i class="fa fa-chevron-right" aria-hidden="true"></i>객체 유형 목록</h3>
			              <div class="navbar-form navbar-right">
							<button type="button" id="btnAtrMgrd" class="btn btn-default">속성관리</button>
	...
	<!-- /.content -->	
    <script src="<spring:url value="/app/admin/pages/objType.js"/>"></script>
</body>
</html>