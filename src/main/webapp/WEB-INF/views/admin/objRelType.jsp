...
<body>
				...
				<div class="collapse navbar-collapse">
					<div class="navbar-form navbar-left">
						<div class="form-group">
							<input id="searchValue" type="text" class="form-control" placeholder="Search" de-search-key=REL_TYPE_NM>
						</div>
	...
	<!-- /.content -->	
    <script src="<spring:url value="/app/admin/pages/objRelType.js"/>"></script>
</body>
</html>