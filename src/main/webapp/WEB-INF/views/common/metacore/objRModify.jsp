				...
				<div class="collapse navbar-collapse">
					<div class="navbar-form navbar-left">
						<div class="form-group">
							<select id="searchKey" class="form-control"></select>
						</div>
						<div class="form-group">
		...
		<div class="content-body row">
			<div class="col-xs-6">
				<div class="box">
		            <div class="box-body">
						<div class="row">
							<button type="button" id="btnAdd" class="btn btn-default btn-block"><span class="glyphicon glyphicon-triangle-right"></span></button>	
						</div>
						<div class="row">
			...
			<div class="col-xs-6">
				<div class="box">
		            <div class="box-body">
						<div class="row">
							<button type="button" id="btnRemove" class="btn btn-default btn-block"><span class="glyphicon glyphicon-triangle-left"></span></button>	
						</div>
						<div class="row">
...
<script src="<spring:url value="/app/common/metacore/objRModify.js"/>"></script>
</body>
</html>