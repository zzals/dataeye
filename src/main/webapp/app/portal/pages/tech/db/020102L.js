$(document).ready(function() {
	...
	var colModel = [	          
		{ index:'OBJ_NM', name: 'OBJ_NM', label: '테이블물리명', width: 100, align:'left', 
      	...
      	{ index:'OBJ_ABBR_NM', name: 'OBJ_ABBR_NM', label: '테이블논리명', width: 100, align:'left'},
	...
	var searchDetail = function() {
		...
		if (tabIndex === 0) {
			if (rowid) {
				...
				var postData = {
					"queryId":"tech.db.findTableColumn",
					"objTypeId":tabColTypeId, 
					"pathObjTypeId":rowObject["OBJ_TYPE_ID"], 
					"pathObjId":rowObject["OBJ_ID"]
				};
