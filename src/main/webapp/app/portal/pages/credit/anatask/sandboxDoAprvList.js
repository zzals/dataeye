...
$(document).ready(function() {
	...
	$("button#btnFile").on("click", function(e) {
		...
		DE.ui.open.popup(
			...
			["sandboxReqPopup"],
			{
				viewname:'pidi/credit/sandboxReqPopup',
				ANATASK_OBJ_TYPE_ID:ANATASK_OBJ_TYPE_ID,
				SB_OBJ_TYPE_ID:SB_OBJ_TYPE_ID,
				mode:'C'
			},
			"left=1, top=1, width=900, height=950, toolbar=no, menubar=no, location=no, resizable=no"
		);
	});
