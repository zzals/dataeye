$(document).ready(function() {
	...
	$("#btnSave").on("click", function(e){
		...
		var board_data={
			...
			B_GRP_SEQ:reqParam['B_GRP_SEQ'],
			B_SORT:reqParam['B_SORT'],
			B_LVL:reqParam['B_LVL']
		}
	...
	var init=function(){
		...
		$(".box-header .box-title").empty().prepend("<i class=\"fa fa-chevron-right\" aria-hidden=\"true\"></i>"+menuNm+"답변");
