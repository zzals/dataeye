...
import com.tableausoftware.documentation.api.rest.bindings.GroupListType;
...
public class Demo {
    ...
    static {
        ...
        try {
        	...
        	Reader reader = Resources.getResourceAsReader("res/config.properties");
        	s_properties.load(reader);
        } catch (IOException e) {
    ...
    public static void main(String[] args) {
        ...
        sb.append("http://192.168.40.221/trusted/");
        sb.append(credential.getToken());
        sb.append("/t/");
        sb.append(credential.getSite().getId());
        sb.append("/views/PEN_OBJ_M/Sheet1");
        ...
        for (ProjectType project : projects.getProject()) {
            if (project.getName().equals("기본값") || project.getName().equals("default") || project.getName().equals("Default")) {
...
//        }
        ...
        System.out.println("############################################");
        GroupListType currentGroups =  s_restApiUtils.invokeQueryGroups(credential, currentSiteId);
        System.out.println(currentGroups.getGroup());
        System.out.println("############################################");
