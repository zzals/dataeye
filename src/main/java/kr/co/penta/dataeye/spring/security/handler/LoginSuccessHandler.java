...
public class LoginSuccessHandler  implements AuthenticationSuccessHandler {
    ...
    private String defaultUrl = "/portal/main2";
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException, ServletException {
        ...
        SessionInfoSupport.setSessionInfo(session, user);
        ...
        if (DataEyeSettingsHolder.getInstance().getConfig().getLoginLoggingEnable()) {
            PenSysSessL penSysSessL = new PenSysSessL(request, DataEyeSettingsHolder.getInstance().getAppId(), PenSysSessL.RSLT_CD.S, PenSysSessL.CONN_TYPE.LOGIN, PenSysSessL.LOGIN_TYPE.DIR);
