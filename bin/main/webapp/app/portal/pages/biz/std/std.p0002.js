$(document).ready(function() {
	...
	var colModel = [
	    { index:'TERM_NM', name: 'TERM_NM', label: '표준용어명', width: 200, align:'left',
	    	...
	    	formatoptions: {
	    		onClick: function (rowid, irow, icol, cellvalue, e) {
	    			...
	    			DE.ui.open.popup(
    					"view",
    					[rowData["TERM_TYPE_ID"], rowData["TERM_OBJ_ID"]],
    					{
	...
	var search = function() {
		var postData = {
			"queryId":"portal.biz.std.findWordUsed",
			"wordId":reqParam["wordId"]
		};
