...
$(document).ready(function() {
	...
	var colModel = [
	    ...
	    { index:'OBJ_NM', name: 'OBJ_NM', label: '정형분석명', width: 600, align:'left',formatter: titleFormat,unformat:titleUnFormat},            	
      	{ index:'OBJ_ATR_VAL_101_NM', name: 'OBJ_ATR_VAL_101_NM', label: '중요도', width: 300, align:'center' 	},
      	{ index:'OBJ_ATR_VAL_102_NM', name: 'OBJ_ATR_VAL_102_NM', label: '활용목적', width:300, align:'center'},
      	{ index:'OBJ_ATR_VAL_104_NM', name: 'OBJ_ATR_VAL_104_NM', label: '활용주기', width: 326, align:'center'},
      	{ index:'OBJ_ATR_VAL_105_NM', name: 'OBJ_ATR_VAL_105_NM', label: '사용자구분', width: 200, align:'left'},
	...
	function iconFormat  (cellvalue, options, rowObject){
		...
		if(rowObject["DD108_OBJ_TYPE_ID"] == "020600L"){
			 img = "<span class=\"effect2\"><img src=\"/dataeye/assets/images/cogunos_icon.gif\" width=\"18px\"></span>"			
		} else {
