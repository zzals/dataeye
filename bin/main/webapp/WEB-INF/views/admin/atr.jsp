...
<body>
				...
				<div class="collapse navbar-collapse">
					<div class="navbar-form navbar-left">
						<div class="form-group">
							<input id="searchValue" class="form-control" placeholder="Search" de-search-key="ATR_NM">
						</div>
				...
				<div class="col-xs-12">
					<div class="box">
			            <div class="box-header">
			              <h3 class="box-title"><i class="fa fa-chevron-right" aria-hidden="true"></i>속성 목록</h3>
	...
	<!-- /.content -->	
    <script src="<spring:url value="/app/admin/pages/atr.js"/>"></script>
</body>
</html>