...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
    	<div class="top_logo">
    	<a href="/dataeye_ebay/portal/main"><font color="#fff">DataEyePortal</font></a>
    	</div>
      ...
      <div class="btn_area">
          	<ul>
          		...
          		<li class="ico"><a href="<spring:url value="../portal/main"/>" ><i class="fa fa-fw fa-question-circle-o" title="Portal 홈"></i><br>Portal 홈</a> </li>
          		<c:if test="${sessionScope[SessionInfoSupport.SESSION_USERINFO_NAME]['admin']}">
          			<li class="ico"><a href="<spring:url value="../admin/main"/>" ><i class="fa fa-fw fa-question-circle-o" title="Admin 홈"></i><br>Admin 홈</a> </li>
          		</c:if>
      ...
      <ul class="sidebar-menu">
       <!--  <li class="header">MAIN NAVIGATION</li> -->
        <li class="active treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>시스템 관리</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="system/application" detag="link"><i class="fa fa-circle-o"></i> Application</a></li>            
            <li><a href="system/user" detag="link"><i class="fa fa-circle-o"></i> 사용자관리</a></li>
            <li><a href="system/menuMgr" detag="link"><i class="fa fa-circle-o"></i> 메뉴관리</a></li>
            <li><a href="system/roleGrpMgr" detag="link"><i class="fa fa-circle-o"></i> ROLE 그룹관리 </a></li>            
            <li><a href="system/authGrpMgr" detag="link"><i class="fa fa-circle-o"></i> 권한 그룹 관리</a></li>
        ...
        <ul class="control-sidebar-menu">
          ...
          <li>
            <a href="<spring:url value="../admin/main"/>">
              ...
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">비식별화관리 홈</h4>
                <p>비식별화 관리</p>
              </div>
            </a>
          </li>
...
<script src="<spring:url value="/app/system/dataeye.system.js"/>"></script>
