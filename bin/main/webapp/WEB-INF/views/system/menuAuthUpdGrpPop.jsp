			...
			<div id="obj_info_m">				
				...
				<div id="obj_info_m_3" class="col-sm-12 form-group">
						...
						<div id="obj_info_det_3" class="col-sm-10">
							<div class="input-group">							
								<input type="hidden" name="userGrpId" id="userGrpId">
								<input class="form-control input-sm" type="text" id="userGrpNm" name="userGrpNm" readonly>								
							</div>
						</div>
				</div>
...
<script language="javascript">
 $(document).ready(function() {
		...
		var init = function() {
			...
			$("#userGrpNm").val(reqParam.userGrpNm);
			$("#userGrpId").val(reqParam.userGrpId);
		...
		$("#btnInsert").click(function (){
			...
			var isFirst = true;
			 ...
			 if(privOpenGbn == 0){
				...
				var rsp = DE.ajax.call({async:false, url:"system/updMenuGrp", data:{"appId":reqParam.appId,"menuId":reqParam.menuId,"privRcvrGbn":"G","privRcvrId":reqParam.userGrpId,"privOpenGbn":privOpenGbn}});
