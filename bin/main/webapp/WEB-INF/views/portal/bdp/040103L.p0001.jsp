...
<body class="de-popup">
	<section id="header">
        <div class="popup_Title_Area">
            <div class="popup_title">설계 컬럼 </div>
				...
				<div class="form-horizontal">
					<div class="box bdt">
						<div class="box-header">
			              	...
			              	<div class="box-tools">
			              		<button id="bntStdCheckAction" type="button" class="btn btn-default" style="display: none;">표준화검증</button>
...
<script src="<spring:url value="/app/portal/pages/bdp/040103L.p0001.js"/>"></script>
</body>
</html>