    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="btn_area">
          	<ul>
          		...
          		<li class="ico"><a href="javascript:goLink('portal/notice/boardList');" title="공지사항"><i class="fa fa-fw fa-bell-o" style="width:50px;"></i><span style="font-size:11px; letter-spacing:-1; width:60px;">공지사항</span></a></li>
          		<li class="ico"><a href="javascript:goLink('portal/qna/boardList');" title="Q&A"><i class="fa fa-fw fa-question-circle-o" style="width:50px;"></i><span style="font-size:11px; letter-spacing:-1; width:60px;">Q&A</span></a></li>          		
