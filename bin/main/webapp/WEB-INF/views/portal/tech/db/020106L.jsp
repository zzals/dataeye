...
<body>
					...
					<div class="navbar-form navbar-right">
						<div class="form-group">
							<select id="searchKey" class="form-control select2" data-placeholder="선택하세요." style="width: 150px;">
			                  	...
			                  	<option value="OBJ_ABBR_NM">프로시저 논리명</option>
			                  	<option value="OBJ_NM">프로시저 물리명</option>
			                </select>
					...
					<div  id="container">
						<div class="box pane ui-layout-center">
							<div class="box-header">
				              	<h3 class="box-title"><i class="fa fa-chevron-right" aria-hidden="true"></i>뷰 목록</h3>
						...
						<div class="box pane ui-layout-south">
							<div class="box-header">
				              	<h3 class="box-title"><i class="fa fa-chevron-right" aria-hidden="true"></i>프로시져 정보</h3>
				              	<div class="navbar-form navbar-right"></div>
				            </div>
				            <div class="box-body">
					            <ul class="nav nav-tabs" id="subTab1" >
					            	<li class="active"><a href="#subTab1-001" data-toggle="tab" aria-expanded="true">스크립트</a></li>
					            </ul>
	...
	<script src="<spring:url value="/app/portal/pages/tech/db/020106L.js"/>"></script>
</body>
</html>