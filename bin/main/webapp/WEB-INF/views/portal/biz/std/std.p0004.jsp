				...
				<div class="collapse navbar-collapse">
					<div class="navbar-form navbar-right de-obj-btn ">
						<c:if test="${AUTH.getRAuth() == 'Y'}">
							<a id="termUploadTplDown" class="btn btn-default">템플릿 다운로드</a>
							<a id="termUploadTplUpload" class="btn btn-default">업로드</a>
							<a id="termVerifyChkAction" class="btn btn-default">용어검증</a>
						</c:if>
...
<script src="<spring:url value="/app/portal/pages/biz/std/std.p0004.js"/>"></script>
</body>
</html>