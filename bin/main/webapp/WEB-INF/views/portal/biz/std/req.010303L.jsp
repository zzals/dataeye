...
<meta name="page-id" content="req.010303L">
...
<body class="de-popup">
	<section id="header">
        <div class="popup_Title_Area">
            <div class="popup_title">표준도메인 결재</div>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse">
					<div class="navbar-form navbar-right">
						<button type="button" id="btnAddDmn" class="btn btn-default" style="display: none;">도메인추가</a>
...
<script src="<spring:url value="/app/portal/pages/biz/std/req.010303L.js"/>"></script>
</body>
</html>