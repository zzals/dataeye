...
<body>
					...
					<div class="navbar-form navbar-right">
						<div class="form-group">
							<select id="searchKey" class="form-control select2" data-placeholder="선택하세요." style="width: 150px;">
			                  	...
			                  	<option value="APRV_DESC">승인내용</option>
			                </select>
				...
				<div class="col-xs-12">
					<div class="box">
			            <div class="box-header">
			              <h3 class="box-title"><i class="fa fa-chevron-right" aria-hidden="true"></i>요청/승인 목록</h3>
	...
	<script src="<spring:url value="/app/portal/pages/biz/std/todo.list.js"/>"></script>
</body>
</html>