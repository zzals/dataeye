...
<script type="text/javascript">
	...
	function displayPaging(page) {
		...
		thisPage = page;
		var param = {"_search":false,"nd":1566802058509,"rows":10,"page":1,"sidx":"","sord":"asc","queryId":"portal.notice.getNoticeTotalCnt","ntc_type_id":"notice","searchKey":$("#searchKey").val(),"searchValue":$("#searchValue").val()}
		$.ajax({ 
	...
	function pageLoad(page){	
		...
		var param = {"_search":false,"nd":1566802058509,"rows":10,"page":1,"sidx":"","sord":"asc","queryId":"portal.notice.getNoticeList","ntc_type_id":"notice","searchKey":$("#searchKey").val(),"searchValue":$("#searchValue").val(),"startNum":startNum,"endNum":endNum}
		$.ajax({ 
		    url:'jqgrid/list', //request 보낼 서버의 경로
		    type:'post', // 메소드(get, post, put 등)
		    contentType: 'application/json; charset=utf-8',
