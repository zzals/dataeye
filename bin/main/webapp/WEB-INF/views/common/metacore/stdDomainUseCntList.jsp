...
<div id="container" de-tag="object-info-pop">
    ...
    <div id="header">
        <div class="popup_Title_Area">
            <div class="popup_title">도메인 사용현황</div>
        </div>
    </div>
    <!-- //HEADER -->
...
<script type="text/javascript">
    $(document).ready(function (){
    	...
    	var colModel = [
    		...
    		{ index:'OBJ_NM', name: 'OBJ_NM', label: '표준용어명', width: 200, align:'left', 
    		...
    		{name : "OBJ_ENG_ABBR_NM", index : "OBJ_ENG_ABBR_NM" ,label: "영문약어명", width : 200 ,sortable:false, align:"left"},    		
    		{name : "CRETR_NM", index : "CRETR_NM" ,label: "등록자", width : 100 ,sortable:false, align:"center"}			
        ];
    	...
    	var init = function() {
    		var postData = {
    				"queryId":"portal_biz.getStdDomainUseCntList",
