    ...
    <section id="header">
        <div class="popup_Title_Area">
	        ...
	        <div class="box-tools pull-right">
	        	<button type="button" class="btn btn-box-tool" onclick="window.close()"><i class="fa fa-remove"></i></button>
	        </div>
        </div>
    </section>
    <!-- //HEADER -->
					...
					<div class="navbar-form navbar-left">
						<div class="form-group">
							<select id="searchKey" class="form-control">
		                        <option value="DMN_OBJ_NM">도메인명</option>
		                        <option value="DMN_GRP_OBJ_NM">도메인그룹명</option>
		                    </select>
						</div>
						<div class="form-group">
...
<script src="<spring:url value="/app/common/metacore/domainSelected.js"/>"></script>
</body>
</html>