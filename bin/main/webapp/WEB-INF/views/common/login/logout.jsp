...
<div class="error_wrap">
	...
	<div class="error_cont"> <img src="<spring:url value="/assets/images/error/error.gif"/>">
        ...
        <div class="error_txt">로그아웃 되었습니다.</div>   
    </div>
    <div class="error_button_Area">
        <!-- <a href="javascript:history.back();"><span class="error_btn">이전 페이지로</span></a> -->
        <a href="<spring:url value="${loginUrl}"></spring:url>"><span class="error_btn">로그인 페이지로</span></a>
    </div> 
</div>
